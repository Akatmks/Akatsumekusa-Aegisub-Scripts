...
local version = require "aka.ljsyscall.syscall.netbsd.version".version

local t, pt, s, ctypes = types.t, types.pt, types.s, types.ctypes

local ffi = require "ffi"
local bit = require "aka.ljsyscall.syscall.bit"

local i6432, u6432 = bit.i6432, bit.u6432

local h = require "aka.ljsyscall.syscall.helpers"
...
local c = require "aka.ljsyscall.syscall.netbsd.constants"
...
local special = {
  ioctl = function(fd, request, val)
    if not ioctlname then
      ioctlname = {}
      local IOCTL = require "aka.ljsyscall.syscall.netbsd.constants".IOCTL -- see #94 as well, we cannot load early as ioctl depends on types
