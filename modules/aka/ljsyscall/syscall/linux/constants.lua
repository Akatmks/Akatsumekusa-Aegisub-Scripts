...
local arch = require("aka.ljsyscall.syscall.linux." .. abi.arch .. ".constants") -- architecture specific code
...
c.errornames = require "aka.ljsyscall.syscall.linux.errors"
