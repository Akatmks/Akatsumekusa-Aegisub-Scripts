...
local fcntl = require("aka.ljsyscall.syscall." .. abi.os .. ".fcntl").init(types)
...
if (abi.rump and abi.types == "netbsd") or (not abi.rump and abi.bsd) then
  S = require("aka.ljsyscall.syscall.bsd.syscalls")(S, hh, c, C, types)
end
S = require("aka.ljsyscall.syscall." .. abi.os .. ".syscalls")(S, hh, c, C, types)
