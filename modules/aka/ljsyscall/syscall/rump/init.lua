...
if abi.host == "netbsd" and abi.types == "netbsd" then -- running native (NetBSD on NetBSD)
  ...
  local C = require "aka.ljsyscall.syscall.rump.c"
  S = require "aka.ljsyscall.syscall.syscalls".init(C, SS.c, SS.types)
...
struct _netbsd_ptyfs_args {
  ...
  local addtype = require "aka.ljsyscall.syscall.helpers".addtype
  local addstructs = {
...
require "aka.ljsyscall.syscall.rump.ffirump"
